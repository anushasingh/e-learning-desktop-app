...
public class StudyTips1Controller implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		img2.setImage(new Image("/Images/1stt1.png"));

		img.setImage(new Image("/Images/1st1.png"));
	...
	private void changeimage(int x) {
		...
		if (x == 1) {
			System.out.println(i);
			img2.setImage(new Image("/Images/2stt1.png"));
			...
			System.out.println(i);
			img2.setImage(new Image("/Images/3stt1.png"));
			...
			System.out.println(i);
			img2.setImage(new Image("/Images/4stt1.png"));
			...
			System.out.println(i);
			img2.setImage(new Image("/Images/5stt1.png"));

			img.setImage(new Image("/Images/5st1.png"));
		}
